...
// Factory (abstract)
public abstract class NotificationFactory  // so we cannot create an object of it
{
    public abstract INotification CreateNotification(); // so all concrete factory have to override or implement it
